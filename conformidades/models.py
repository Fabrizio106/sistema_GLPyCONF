...
class CertificadoConformidad(models.Model):
    ...
    longitud = models.CharField(max_length=15, blank=True, null=True, verbose_name="Longitud (m)")
    altura = models.CharField(max_length=15, blank=True, null=True, verbose_name="Altura (m)")
    ancho = models.CharField(max_length=15, blank=True, null=True, verbose_name="Ancho (m)")
...
class TramiteConformidad(models.Model):
    ...
    certificado = models.ForeignKey(CertificadoConformidad, on_delete=models.CASCADE, related_name='tramites', verbose_name="Certificado Asociado")
    tipo_nombre = models.CharField(max_length=50, choices=TIPO_TRAMITE_CHOICES, verbose_name="Tipo de Trámite")
    campo_modificado = models.CharField(max_length=50, verbose_name="Dato a cambiar")
    valor_nuevo = models.CharField(max_length=255, verbose_name="Nuevo Valor")
    nota = models.TextField(blank=True, null=True, verbose_name="Nota de la Modificación")  # ← de Estefano
